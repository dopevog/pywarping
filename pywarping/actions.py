...
from pywarping.base import DisplacementField
from pywarping.detect import LANDMARK_NAMES, LandmarkFace, LandmarkFaces
from pywarping.reference import DefaultRS
...
class LinearTransform(Action):
    ...
    reference_space : None or pywarping.reference.ReferenceSpace
